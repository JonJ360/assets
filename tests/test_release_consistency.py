...
class ReleaseConsistencyTests(unittest.TestCase):
    def test_visible_release_is_v139_on_all_pages(self):
        self.assertIn('id="verTag">v1.39', text("index.html"))
        self.assertIn('IRP · IFTA · 2290 &nbsp; v1.39', text("irp.html"))
        self.assertIn('<span class="ver">v1.39</span>', text("docs.html"))
